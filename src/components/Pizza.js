    ...
    <>
      <article className="w-[300px] h-[400px] ml-10 mt-6 mb-14 bg-black rounded-[40px] pt-1.5">
        <main>
          ...
          <div className="text-[20px] font-bold text-white ml-2 font-['Nunito']">
            {pizzas.title}
          </div>
        ...
        <footer className="h-max flex place-items-end ml-2">
          ...
          <button className="w-[120px] h-[40px] flex ml-20 bg-white rounded-full float-right items-center pl-[25px] text-orange-black font-bold font-['Nunito']">
            Выбрать
          </button>
        </footer>
      </article>
